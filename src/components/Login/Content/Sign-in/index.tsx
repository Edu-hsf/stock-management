        ...
        <div className="sign-in">
            <form onSubmit={handleSubmit(loginUser)} className="sign-in-form">
                <div className="form-group mt-2">
                    ...
                    />
                    {errors.emailLogin ? (
                        <div className="w-100 d-flex"><span className='error-message'>{String(errors.emailLogin.message)}</span></div>
                    ) : null}
                </div>
                <div className="form-group mt-2">
                    ...
                    {errors.passwordLogin ? (
                        <div className="w-100 d-flex"><span className='error-message'>{String(errors.passwordLogin.message)}</span></div>
                    ) : null}
                </div>
            ...
            <div className="sign-in-link mt-3">
                <p className="text-center text-secondary">Don't have an account? <span className="text-primary cursor-pointer" onClick={() => {
                    setMove_x && setMove_x('left')
                    setMove_y && setMove_y('top')
                }}>Sign-Up</span></p>
            </div>
